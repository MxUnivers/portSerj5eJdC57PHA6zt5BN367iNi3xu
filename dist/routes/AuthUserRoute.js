      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          if (validate) {
            ...
            secretKey = 'clé_sécrète'; // la clé secrète utilisée pour signer le jeton
            options = {
              expiresIn: '24h'
            };
            _token = jwt.sign(payload, secretKey, options);
            user.status = false;
            user.save();
            res.status(200).json({
...
router.post('/disconnect/:id', function (_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          user.save();
          res.status(200).json({
            message: "utlisateur déconnecté de l'application"
          });
          _context2.next = 12;
          break;
        case 9:
...
// set password
router.put('/auth/password/:id', function (_x5, _x6) {
