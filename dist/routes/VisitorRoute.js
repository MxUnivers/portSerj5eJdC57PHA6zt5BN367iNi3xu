...
var Visitor = require("../models/VisitorModel");
var router = require("express").Router();
var nbVisits = 0;
// CREATE
router.post("/visit", function (_x, _x2) {
...
// GET ALL TEST
router.get("/nbVisits", function (_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          res.status(405).json({
            Visitor: "Erreur lors de récuperation"
          });
        case 11:
        case "end":
