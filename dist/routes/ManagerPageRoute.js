...
var ManagerPage = require("../models/ManagerPageModel");
  ...
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          manager = new ManagerPage(req.body);
          _context.next = 4;
          return manager.save();
        case 4:
          _context.next = 6;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return ManagerPage.findOneAndUpdate({
            _id: req.params.id
          }, req.body);
        case 3:
...
// GET ALL TEST
router.get("/get/all", function (_x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return ManagerPage.find({});
        case 3:
          manager = _context3.sent;
          _context3.next = 6;
          return res.status(200).json({
            data: manager.reverse()
          });
        case 6:
          _context3.next = 11;
          break;
...
// DELETE 
router.get("/delete/:id", function (_x7, _x8) {
