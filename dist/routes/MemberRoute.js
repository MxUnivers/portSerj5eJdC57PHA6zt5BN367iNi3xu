...
var user = require("../models/MemberModel");
var router = require("express").Router();

// CREATE
router.post("/", function (_x, _x2) {
...
// EDIT
router.put("/:id", function (_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _user2.findOneAndUpdate({
            _id: req.params.id
          }, req.body);
        case 3:
...
// GET SCHOOL ID
router.get("/:id", function (_x5, _x6) {
...
// GET ALL TEST
router.get("/get/all", function (_x7, _x8) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          ...
          res.status(405).json({
            message: "Erreur lors de récuperation"
          });
        case 11:
        case "end":
...
// AVAILAID
router.get("/hide/:id", function (_x9, _x10) {
...
// VALID
router.get("/show/:id", function (_x11, _x12) {
...
// DELETE 
router.get("/delete/:id", function (_x13, _x14) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _context7.next = 3;
          return _user7.findByIdAndDelete({
            _id: req.params.id
          });
        case 3:
          _user7 = _context7.sent;
          res.status(200).json({
            data: _user7,
            message: "Deboqué"
          });
