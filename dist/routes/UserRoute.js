...
router.put('password/:id', function (_x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 12:
          ...
          return res.status(200).json({
            data: user,
            message: 'Modifier mot de passe modifier avec succès'
          });
        case 14:
          _context3.next = 19;
          break;
...
// GET SCHOOL ID
router.get("/:id", function (_x7, _x8) {
...
// GET ALL TEST
router.get("/get/all", function (_x9, _x10) {
...
// DELETE 
router["delete"]("/delete/:id", function (_x15, _x16) {
